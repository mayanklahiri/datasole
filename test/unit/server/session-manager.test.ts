...
import { SessionManager } from '../../../src/server/primitives/state/session-manager';
...
describe('SessionManager', () => {
  ...
  it('set and get values per user', async () => {
  ...
  it('set increments version and fires onChange', async () => {
    const sm = new SessionManager(new MemoryBackend(), { flushIntervalMs: 0 });
